...
public class NoticeController {
	...
	private final UserService userService;
	 ...
	 @GetMapping("/list")	 
	 public String noticelist(Model model, @RequestParam(value = "kw", defaultValue = "") String kw) {
	 ...
	 //"#principal != null and #principal.username == 'admin'"
	  ...
	  public String noticeCreate(@Valid NoticeForm noticeForm, BindingResult bindingResult, Principal principal) {
	    ...
	    public String noticeModify(@Valid NoticeForm noticeForm, @PathVariable(required = true ,name="id") Integer id, Principal principal) {
	        Notice notice = this.noticeService.getNotice(id);
	    ...
	    public String noticeModify(@Valid NoticeForm noticeForm, BindingResult bindingResult, 
	        ...
	        return String.format("redirect:/n/detail/%s", id);
	    }
	    @PreAuthorize("isAuthenticated()")
